...
print('| _   _|')
print('|   |  |')
print('|  _|  |    -- when I wasted my sunday morning doing this shit...')
print('|      |')
print('|     |')
print('|     |')
print('\n')
print('%s.png of size %dx%d was create after %d iterations, lol' % (file_name, png_size, png_size, for_loop_iterations))
print('\n')
